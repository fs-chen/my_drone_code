...
uint16_t ButtonVisionHeartCnt=0;
uint16_t HorizonVisionHeartCnt=0;
//两个视觉识别的心跳定时
uint8_t HorizonVisionErroFlag=0;
uint8_t ButtonVisionErroFlag=0;
//视觉模块失联错误标志位 
...
void TIM3_IRQHandler(void)
{
	...
	{		
		//1s的判断门限
//		if(ButtonVisionHeartCnt>=2500)
//		{
//			ButtonVisionErroFlag=1;
//		}
//		else
//		{
//			ButtonVisionHeartCnt++;
//		}
		if(HorizonVisionHeartCnt>=2500)
		{	
			HorizonVisionErroFlag=1;
		}
		else
		{
			if(RequireFlag)
				HorizonVisionHeartCnt++;
			else
