...
//串口模式选择
//#define Usart_mode GPIO_ReadInputDataBit(GPIOA,GPIO_Pin_4)==0?1:0  //K3
#define Take_Off GPIO_ReadInputDataBit(GPIOC,GPIO_Pin_4)==0?1:0		//K2
#define CircleMode GPIO_ReadInputDataBit(GPIOC,GPIO_Pin_5)==0?1:0		//K1
#define LineInspectMode GPIO_ReadInputDataBit(GPIOA,GPIO_Pin_4)==0?1:0  //K3
//BEEP
